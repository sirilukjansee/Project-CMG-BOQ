            ...
            <div class="intro-y input-form box p-5">
                <div class="grid grid-cols-2 gap-2">
                    <div class="input-form mt-3">
                        ...
                        <select name="brand" id="validation-form-1" data-placeholder="Select a brand..."
                            class="tom-select form-control w-full">
                    ...
                    <div class="input-form mt-3">
                        ...
                        <select id="validation-form-2" name="location" data-placeholder="Select a location..."
                            autocomplete="off" class="tom-select form-control w-full">
                ...
                <div class="grid grid-cols-8 gap-2">
                    ...
                    <div class="col-span-12 xl:col-span-2 mt-3">
                        <div class="input-form mt-2 xl:mt-0">
                            ...
                            <select id="select-beast-empty2" name="task" data-placeholder="Select a task type..."
                                autocomplete="off" class="tom-select form-control w-full">
                    ...
                    <div class="col-span-12 xl:col-span-2 mt-3">
                        <div class="input-form mt-2 xl:mt-0">
                            ...
                            <select id="select-beast-empty3" name="task_n" data-placeholder="Select a task name..."
                                autocomplete="off" class="tom-select form-control w-full">
                ...
                <div class="grid grid-cols-8 gap-2">
                    <div class="col-span-12 xl:col-span-2 mt-3">
                        <div class="input-form mt-2 xl:mt-0">
                            ...
                            <input id="validation-form-6" type="date" name="startDate" class="form-control"
                                value="{{ date('d-m-y') }}">
                            @error('startDate')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                ...
                <div class="grid grid-cols-2 gap-2">
                    <div class="input-form mt-3">
                        ...
                        <select name="ds_name" id="validation-form-8" data-placeholder="Select a designer..."
                            autocomplete="off" class="tom-select form-control w-full">
                ...
                success: function(response) {
                    ...
                    if (response.chk_io.length > 1) {
                        jQuery.each(response.chk_io, function(key, value) {
                            if (value.brand != chk) {
                                $('#comment').text("'" + id +
                                    "' มีอยูในโครงการอื่นแล้วจ้าาาาาาาา !");
                            }
                        });
                        // console.log("Yay");
                    }
