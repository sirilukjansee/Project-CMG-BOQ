<table style="border-collapse: collapse;">
    ...
    <tbody>
        ...
        @if (Carbon\Carbon::parse($exp->created_at)->format('d-m-Y') == Carbon\Carbon::today()->format('d-m-Y') || Carbon\Carbon::parse($exp->updated_at)->format('d-m-Y') == Carbon\Carbon::today()->format('d-m-Y'))
        <tr>
